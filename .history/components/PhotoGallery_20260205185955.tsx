      ...
      {selectedIndex !== null && (
        <div className="fixed inset-0 bg-black bg-opacity-90 z-50 flex items-center justify-center">
          ...
          <button
            ...
            className="absolute right-4 top-1/2 transform -translate-y-1/2 text-white text-3xl disabled:opacity-50"
          >
            →
          </button>
          ...
          <div className="absolute bottom-4 left-0 right-0 text-center text-white">
            ...
            <p className="text-sm opacity-75">Use arrow keys or click to navigate</p>
          </div>
        </div>
      )}
    </div>
