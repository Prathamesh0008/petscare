          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-8 sm:gap-10 lg:gap-12 items-center">
              ...
              <div className="text-white space-y-5 sm:space-y-6 md:space-y-8 text-center lg:text-left">
                <div className="inline-flex items-center justify-center lg:justify-start gap-2 sm:gap-3 bg-gradient-to-r from-[#b87d5e]/30 to-[#2c4a3e]/30 backdrop-blur-lg px-4 sm:px-6 py-2 sm:py-3 rounded-xl sm:rounded-2xl border border-white/20 shadow-lg mx-auto lg:mx-0">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-3 sm:gap-4 pt-2 sm:pt-4">
                  <button className="group bg-[#b87d5e] hover:bg-[#9e6a4f] text-white font-bold px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 md:py-4 rounded-lg sm:rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 flex items-center gap-2 sm:gap-3 hover:-translate-y-1 text-sm sm:text-base">
              ...
              <div className="space-y-4 sm:space-y-5 md:space-y-6 mt-6 lg:mt-0">
                <div className="grid grid-cols-2 gap-3 sm:gap-4 md:gap-5 lg:gap-6">
                  <div className="bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl border border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 transform hover:-translate-y-1 sm:hover:-translate-y-2 transition-all duration-300 hover:shadow-2xl">
                    <div className="flex items-center justify-between mb-2 sm:mb-3 md:mb-4">
                      <FaPaw className="text-[#b87d5e] text-lg sm:text-xl md:text-2xl" />
                    ...
                    <div className="h-0.5 sm:h-1 bg-gradient-to-r from-[#b87d5e] to-transparent rounded-full mt-2 sm:mt-3"></div>
                  </div>
                  
                  <div className="bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl border border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 transform hover:-translate-y-1 sm:hover:-translate-y-2 transition-all duration-300 hover:shadow-2xl">
                    <div className="flex items-center justify-between mb-2 sm:mb-3 md:mb-4">
                      <FaRupeeSign className="text-[#b87d5e] text-lg sm:text-xl md:text-2xl" />
                  ...
                  <div className="bg-gradient-to-br from-white/15 to-white/5 backdrop-blur-xl border border-white/20 rounded-xl sm:rounded-2xl p-4 sm:p-5 md:p-6 transform hover:-translate-y-1 sm:hover:-translate-y-2 transition-all duration-300 hover:shadow-2xl col-span-2">
                    <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
                      <div>
                        <div className="flex items-center justify-between mb-2 sm:mb-3 md:mb-4">
                          <FaHandsHelping className="text-[#b87d5e] text-lg sm:text-xl md:text-2xl" />
                ...
                {/* Trust Badge */}
                <div className="bg-gradient-to-r from-[#2c4a3e]/30 to-[#b87d5e]/30 backdrop-blur-lg border border-white/20 rounded-xl sm:rounded-2xl p-3 sm:p-4 md:p-5">
                  <div className="flex items-center gap-3 sm:gap-4">
                    <div className="bg-[#b87d5e]/20 p-2 sm:p-3 rounded-lg sm:rounded-xl">
                      <FaShieldAlt className="text-[#b87d5e] text-lg sm:text-xl md:text-2xl" />
                    </div>
                    <div>
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-10 md:py-12">
        <div className="grid lg:grid-cols-3 gap-6 sm:gap-7 md:gap-8">
          ...
          <div className="lg:col-span-2 space-y-6 sm:space-y-7 md:space-y-8">
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl border border-gray-100 p-5 sm:p-6 md:p-8 hover:shadow-lg transition-all duration-300">
              <div className="flex items-center gap-3 sm:gap-4 mb-5 sm:mb-6 md:mb-8">
                <div className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-gradient-to-br from-[#b87d5e]/10 to-[#2c4a3e]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <FaHeart className="text-[#b87d5e] text-base sm:text-lg md:text-xl" />
                </div>
                <div>
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Choose Your Support</h2>
                  <p className="text-xs sm:text-sm text-gray-600">Select how you'd like to make a difference</p>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4 mb-6 sm:mb-8 md:mb-10">
                {donationTypes.map((type) => (
                  ...
                  >
                    <div className={`w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 ${type.color} rounded-lg flex items-center justify-center mb-2 sm:mb-3 md:mb-4`}>
                      <div className={`${type.textColor} text-sm sm:text-base md:text-lg`}>
                        {type.icon}
                      </div>
                    </div>
                    <h3 className="font-bold text-gray-900 text-sm sm:text-base mb-1">{type.title}</h3>
              ...
              <div className="mb-6 sm:mb-8 md:mb-10">
                <h3 className="text-base sm:text-lg md:text-xl font-bold text-gray-900 mb-4 sm:mb-5 md:mb-6">Select Amount (₹)</h3>
                    ...
                    >
                      ...
                      {option.popular && (
                        <div className="mt-2 sm:mt-3">
                          <span className="bg-[#b87d5e] text-white text-[10px] sm:text-xs px-2 sm:px-3 py-0.5 sm:py-1 rounded-full">
                            Most Popular
                          </span>
                        </div>
                      )}
              ...
              {/* Donation Form */}
              <div className="bg-gradient-to-b from-[#b87d5e]/5 to-white rounded-lg sm:rounded-xl p-4 sm:p-5 md:p-6 border border-[#b87d5e]/20">
                <DonationForm 
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl border border-gray-100 p-5 sm:p-6 md:p-8 hover:shadow-lg transition-all duration-300">
              <div className="flex items-center gap-3 sm:gap-4 mb-5 sm:mb-6 md:mb-8">
                <div className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-gradient-to-br from-[#b87d5e]/10 to-[#2c4a3e]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                  <FaChartPie className="text-[#b87d5e] text-base sm:text-lg md:text-xl" />
                </div>
                <div>
                  <h2 className="text-lg sm:text-xl md:text-2xl font-bold text-gray-900">Financial Transparency</h2>
                  <p className="text-xs sm:text-sm text-gray-600">See exactly where your money goes</p>
                </div>
              </div>
                ...
                {whereMoneyGoes.map((item, index) => (
                  <div key={index} className="space-y-1 sm:space-y-2">
                    <div className="flex items-center justify-between">
                      <div className="font-medium text-gray-900 text-sm sm:text-base">{item.category}</div>
                      <div className="text-base sm:text-lg font-bold text-[#b87d5e]">{item.percentage}%</div>
                    </div>
                    <div className="w-full bg-[#b87d5e]/10 rounded-full h-1.5 sm:h-2 overflow-hidden">
                      <div
              ...
              <div className="mt-6 sm:mt-8 md:mt-10 p-4 sm:p-5 md:p-6 bg-gradient-to-br from-[#b87d5e]/5 to-[#2c4a3e]/5 rounded-lg sm:rounded-xl border border-[#b87d5e]/20">
                <div className="flex flex-col sm:flex-row items-start gap-3 sm:gap-4">
                  <div className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 bg-gradient-to-br from-[#b87d5e]/10 to-[#2c4a3e]/10 rounded-lg flex items-center justify-center flex-shrink-0">
                    <FaCertificate className="text-[#b87d5e] text-base sm:text-lg md:text-xl" />
                  </div>
                  <div className="flex-1">
                    <h4 className="font-bold text-gray-900 text-sm sm:text-base mb-2 sm:mb-3">Our Transparency Promise</h4>
                    ...
                    <button className="inline-flex items-center gap-1 sm:gap-2 text-[#b87d5e] font-medium hover:text-[#9e6a4f] text-xs sm:text-sm hover:gap-2 sm:hover:gap-3 transition-all duration-300">
                      View Annual Report
          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="lg:sticky lg:top-8">
              <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5 md:p-6 hover:shadow-lg transition-all duration-300">
                <DonationProgress />
              </div>

              {/* Your Impact */}
              <div className="bg-gradient-to-br from-[#b87d5e] to-[#9e6a4f] text-white rounded-xl p-4 sm:p-5 md:p-6 mt-5 sm:mt-6">
              ...
              {/* Tax Benefits */}
              <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5 md:p-6 mt-5 sm:mt-6 hover:shadow-lg transition-all duration-300">
                <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5 md:mb-6">
                  <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 bg-gradient-to-br from-[#b87d5e]/10 to-[#2c4a3e]/10 rounded-lg flex items-center justify-center">
                    <FaGift className="text-[#b87d5e] text-sm sm:text-base" />
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900 text-sm sm:text-base">Tax Benefits</h3>
                    <p className="text-gray-600 text-xs">Maximize your giving</p>
                  </div>
                </div>
                
                <div className="space-y-2 sm:space-y-3 mb-4 sm:mb-5 md:mb-6">
                  <div className="flex items-center gap-2 sm:gap-3">
                    <FaCheckCircle className="text-[#b87d5e] text-xs sm:text-sm flex-shrink-0" />
                    <span className="text-gray-700 text-xs sm:text-sm">50% tax deduction under 80G</span>
                  </div>
                  <div className="flex items-center gap-2 sm:gap-3">
                    <FaCheckCircle className="text-[#2c4a3e] text-xs sm:text-sm flex-shrink-0" />
                    <span className="text-gray-700 text-xs sm:text-sm">Valid for individuals & companies</span>
                  </div>
                  <div className="flex items-center gap-2 sm:gap-3">
                    <FaCheckCircle className="text-[#b87d5e] text-xs sm:text-sm flex-shrink-0" />
                    <span className="text-gray-700 text-xs sm:text-sm">CSR compliance certificates</span>
                  </div>
                </div>
                
                <button className="w-full bg-[#b87d5e] hover:bg-[#9e6a4f] text-white font-semibold py-2 sm:py-2.5 rounded-lg transition-all duration-300 text-xs sm:text-sm">
              ...
              <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5 md:p-6 mt-5 sm:mt-6 hover:shadow-lg transition-all duration-300">
                <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5 md:mb-6">
                  <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 bg-gradient-to-br from-[#b87d5e]/10 to-[#2c4a3e]/10 rounded-lg flex items-center justify-center">
                    <FaBuilding className="text-[#b87d5e] text-sm sm:text-base" />
                  </div>
                  <div>
                    <h3 className="font-bold text-gray-900 text-sm sm:text-base">Corporate Partnerships</h3>
                    <p className="text-gray-600 text-xs">Meaningful CSR opportunities</p>
                  </div>
                </div>
                
                <p className="text-gray-700 text-xs sm:text-sm mb-4 sm:mb-5 md:mb-6">
              ...
              {/* Security Features */}
              <div className="bg-white rounded-xl border border-gray-100 p-4 sm:p-5 md:p-6 mt-5 sm:mt-6 hover:shadow-lg transition-all duration-300">
                <h3 className="font-bold text-gray-900 text-sm sm:text-base mb-4 sm:mb-5 md:mb-6">Secure Giving</h3>
                
                <div className="space-y-3 sm:space-y-4">
                  {securityFeatures.map((feature, index) => (
                    <div key={index} className="flex items-center gap-2 sm:gap-3">
                      <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 bg-gradient-to-b from-[#b87d5e]/5 to-white rounded-lg flex items-center justify-center flex-shrink-0 border border-[#b87d5e]/20">
                        <div className="text-[#b87d5e] text-xs sm:text-sm">
                          {feature.icon}
                        </div>
                      </div>
                      <div>
                        <div className="font-medium text-gray-900 text-xs sm:text-sm">{feature.title}</div>
                        <div className="text-[10px] sm:text-xs text-gray-600">{feature.description}</div>
                      </div>
                    </div>
                  ))}
                </div>
              ...
              <div className="bg-gradient-to-br from-[#b87d5e]/5 to-white rounded-xl border border-[#b87d5e]/20 p-4 sm:p-5 md:p-6 mt-5 sm:mt-6">
                <h3 className="font-bold text-gray-900 text-sm sm:text-base mb-4 sm:mb-5 md:mb-6">Other Ways to Support</h3>
                
                <div className="space-y-3 sm:space-y-4">
                  <a 
                    href="/volunteer" 
                    className="group flex items-center justify-between p-3 sm:p-4 rounded-lg border border-gray-200 bg-white hover:border-[#b87d5e] hover:shadow-sm transition-all duration-300"
                  >
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 bg-gradient-to-br from-[#b87d5e]/10 to-[#2c4a3e]/10 rounded-lg flex items-center justify-center">
                        <FaUsers className="text-[#b87d5e] text-xs sm:text-sm" />
                      </div>
                      <div>
                        <div className="font-medium text-gray-900 text-xs sm:text-sm">Volunteer</div>
                        <div className="text-[10px] sm:text-xs text-gray-600">Donate your time</div>
                      </div>
                    </div>
                    <FaArrowRight className="text-gray-400 group-hover:text-[#b87d5e] group-hover:translate-x-1 transition-all duration-300 text-[10px] sm:text-xs" />
                  </a>
                  
                  <a 
                    href="/foster" 
                    className="group flex items-center justify-between p-3 sm:p-4 rounded-lg border border-gray-200 bg-white hover:border-[#2c4a3e] hover:shadow-sm transition-all duration-300"
                  >
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 bg-gradient-to-br from-[#2c4a3e]/10 to-[#b87d5e]/10 rounded-lg flex items-center justify-center">
                        <FaHeart className="text-[#2c4a3e] text-xs sm:text-sm" />
                      </div>
                      <div>
                        <div className="font-medium text-gray-900 text-xs sm:text-sm">Foster Care</div>
                        <div className="text-[10px] sm:text-xs text-gray-600">Provide temporary home</div>
                      </div>
                    </div>
                    <FaArrowRight className="text-gray-400 group-hover:text-[#2c4a3e] group-hover:translate-x-1 transition-all duration-300 text-[10px] sm:text-xs" />
                  </a>
                  ...
                  >
                    <div className="flex items-center gap-2 sm:gap-3">
                      <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 bg-gradient-to-br from-[#b87d5e]/10 to-[#2c4a3e]/10 rounded-lg flex items-center justify-center">
                        <FaGift className="text-[#b87d5e] text-xs sm:text-sm" />
                      </div>
                      <div>
                        <div className="font-medium text-gray-900 text-xs sm:text-sm">Wishlist</div>
                        <div className="text-[10px] sm:text-xs text-gray-600">Donate supplies</div>
                      </div>
                    </div>
                    <FaArrowRight className="text-gray-400 group-hover:text-[#b87d5e] group-hover:translate-x-1 transition-all duration-300 text-[10px] sm:text-xs" />
                  </a>
        ...
        {/* Trust Section */}
        <div className="mt-12 sm:mt-14 md:mt-16 bg-gradient-to-br from-[#b87d5e]/5 to-[#2c4a3e]/5 rounded-xl sm:rounded-2xl p-5 sm:p-6 md:p-8 lg:p-10 border border-[#b87d5e]/20">
          <div className="text-center mb-6 sm:mb-7 md:mb-8 lg:mb-10">
            <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-gray-900 mb-2 sm:mb-3">Secure & Trusted Giving</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5 md:gap-6 lg:gap-8 max-w-4xl mx-auto">
            {securityFeatures.map((feature, index) => (
              <div key={index} className="text-center group">
                <div className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 lg:w-14 lg:h-14 bg-gradient-to-br from-[#b87d5e] to-[#2c4a3e] rounded-lg flex items-center justify-center text-white mx-auto mb-2 sm:mb-3 md:mb-4 group-hover:scale-105 transition-transform duration-300">
                  <div className="text-sm sm:text-base md:text-lg lg:text-xl">
                    {feature.icon}
                  </div>
                </div>
                <h3 className="font-bold text-gray-900 text-xs sm:text-sm md:text-base mb-1">{feature.title}</h3>
                <p className="text-[10px] sm:text-xs text-gray-600">{feature.description}</p>
              </div>
