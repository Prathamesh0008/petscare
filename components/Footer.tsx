...
export default function Footer() {
  ...
  return (
    <footer className="relative bg-[#223d7c] text-white pt-16 pb-8">
          ...
          <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-white/10">
            <div className="flex flex-col lg:flex-row items-center justify-between gap-6 lg:gap-8">
              <div className="flex items-center gap-4">
                <div className="w-12 h-12 sm:w-14 sm:h-14 bg-[#1b93d1]/20 rounded-xl flex items-center justify-center">
                  <FaPaperPlane className="text-xl sm:text-2xl text-[#1b93d1]" />
                </div>
                <div>
                  <h3 className="text-xl sm:text-2xl font-bold mb-1">
                    Stay <span className="text-[#1b93d1]">Updated</span>
                  </h3>
                  <p className="text-white/60 text-sm max-w-md">
                    Subscribe for updates on new arrivals, events, and success stories.
                  </p>
                </div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="w-full lg:w-auto">
                <div className="flex flex-col sm:flex-row gap-3">
                  <div className="relative flex-grow">
                    ...
                    <input
                      ...
                      className="w-full sm:w-80 pl-10 pr-4 py-3 bg-white/10 border border-white/20 rounded-lg text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-[#1b93d1] focus:border-transparent transition-all text-sm"
                      required
                    />
                  </div>
                  <button
                ...
                {subscribed && (
                  <motion.div
                    ...
                    className="mt-3 text-[#1b93d1] text-xs flex items-center gap-2"
                  >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12 mb-12">
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-[#1b93d1]/20 rounded-lg flex items-center justify-center">
                <FaPaw className="text-lg text-[#1b93d1]" />
              </div>
              <h3 className="text-xl font-bold">
                Paw<span className="text-[#1b93d1]">Heaven</span>
              </h3>
            </div>
            ...
            <div className="flex gap-2">
              {[
                ...
                <a
                  ...
                  className="w-8 h-8 bg-white/10 rounded-lg flex items-center justify-center text-white/60 hover:bg-[#1b93d1] hover:text-white transition-all duration-300 text-sm"
                >
                  {social.icon}
                </a>
              ))}
            ...
            <ul className="space-y-2">
              {[
                ...
                <li key={index}>
                  <Link 
                    href={link.href} 
                    className="text-white/60 hover:text-[#1b93d1] transition-colors duration-300 text-sm flex items-center gap-2"
                  >
                    <span className="w-1 h-1 bg-[#1b93d1]/60 rounded-full" />
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          >
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a 
                  ...
                  className="text-white/60 hover:text-[#1b93d1] transition-colors duration-300 text-sm"
                >
                  {SHELTER_INFO.phone}
                </a>
              </li>
            ...
            <div className="mt-4 p-3 bg-white/5 rounded-lg border border-white/10">
              <div className="flex items-center gap-2 text-[#1b93d1] mb-1">
                <FaHeart className="text-xs" />
                <span className="text-xs font-medium">Emergency?</span>
              </div>
              <p className="text-white/60 text-xs">
                24/7 Helpline: <a href="tel:+919876543210" className="text-[#1b93d1] hover:underline">+91 98765 43210</a>
              </p>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-white/40 text-xs">
              © {currentYear} PawHeaven Vashi. Made with <FaHeart className="inline text-[#1b93d1] text-xs mx-1" /> for animals.
            </p>
            ...
            <div className="flex gap-4">
              {[
                ...
                <Link
                  key={index}
                  href={link.href}
                  className="text-white/40 hover:text-[#1b93d1] text-xs transition-colors duration-300"
                >
                  {link.label}
                </Link>
              ))}
